...
FINAL_IMAGE=${DISTDIR}/P2-PARCIAL2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=P2-PARCIAL2.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/P2-PARCIAL2.o
POSSIBLE_DEPFILES=${OBJECTDIR}/P2-PARCIAL2.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/P2-PARCIAL2.o

# Source Files
SOURCEFILES=P2-PARCIAL2.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/P2-PARCIAL2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F57Q84
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/P2-PARCIAL2.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/P2-PARCIAL2.o: P2-PARCIAL2.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/P2-PARCIAL2.o 
	${MP_AS} -mcpu=PIC18F57Q84 -c \
	-o ${OBJECTDIR}/P2-PARCIAL2.o \
	P2-PARCIAL2.s \
